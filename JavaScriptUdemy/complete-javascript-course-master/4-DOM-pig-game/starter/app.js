...
document.querySelector('.btn-roll').addEventListener('click', function (){
    if(isPlaying) {
        ...
        var diceDOM = document.querySelector('.dice'); //allows editing of css
...
function init() {
    ...
    roundScore =0; 
    goal = 1; 
    document.querySelector('.dice').style.display= 'none'; //sets the css property to none for that class 
